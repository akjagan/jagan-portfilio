...
//                 <div
//                   key={idx}
//                   className="p-6 bg-white dark:bg-gray-800 shadow-lg rounded-lg border dark:border-gray-700 hover:scale-105 transition-transform hover:shadow-xl"
//                 >
...
//                       <span
//                         key={i}
//                         className="px-3 py-1 bg-gray-200 dark:bg-gray-700 text-sm rounded-md hover:bg-blue-500 hover:text-white transition-colors duration-300"
//                       >
//                         {tech}
//                       </span>
//                     ))}
