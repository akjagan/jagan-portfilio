...
// const Hero = () => {
//   return (
//     <section className="h-screen flex flex-col items-center justify-center text-center bg-gradient-to-b from-gray-900 to-gray-700 text-white px-6">
//       {/* Profile Image */}
//       <motion.img
//         src="/Ganishwar.png"
//         alt="Ganishwar Arun"
...
//           href="/Ganishwar_Resume.pdf"
//           download="Ganishwar_Resume.pdf"
//           className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg text-lg font-semibold transition-transform transform hover:scale-105"
//         >
//           Download Resume
//         </a>
//         <Link
//           to="/contact"
//           className="bg-gray-800 hover:bg-gray-900 text-white px-6 py-3 rounded-lg text-lg font-semibold transition-transform transform hover:scale-105"
//         >
//           Contact Me
//         </Link>
//       </motion.div>
